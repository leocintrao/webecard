...
$db['default']['password'] = '';
$db['default']['database'] = 'aranha';
} 

elseif ($_SERVER['HTTP_HOST'] == "testing.webecard.net" || $_SERVER['HTTP_HOST'] == "www.testing.webecard.net") { 

$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'leolondo_leo';
$db['default']['password'] = '35481176';
$db['default']['database'] = 'leolondo_tes_aranha';
} 
...
$db['default']['username'] = 'leolondo_leo';
$db['default']['password'] = '35481176';
$db['default']['database'] = 'leolondo_aranha';
