...
class Pagseguro_ctrl extends CI_Controller{
...
$desc = $this->session->userdata('log_user_name') . " Crédito WEBECARD.net";
$cred_valor = $this->session->userdata('cred_valor') . ",00";
