...
<div id='faux'>
	...
	echo form_open('main/signup_basic_validation');
...
?>
		...
		<td> <?php //echo form_input('cpf', $this->input->post('cpf'), $size1); ?> 
		<span class='aste' >*</span> 
		...
		-->
		<tr>
		<td class='form_right'> Parte da Rede: </td> <td> <?php echo "<input type='text' name='nada' style='color:gray;' value='$user_name' size='40' readonly> "; ?> 
									   <?php echo form_hidden('rede', $user_id); ?> 
