...
class CreatePaymentRequestLightbox
{
    ...
    public static function main()
    {
        ...
        //$paymentRequest->setReference('reflele');
/*
        ...
        $paymentRequest->addParameter('notificationURL', 'http://www.testing.webecard.net/assets/admin/ps/notificacao.php');
...
*/
        ...
        $paymentRequest->setRedirectUrl("http://www.testing.webecard.net/");
    ...
    public static function printPaymentUrl($code)
    {
        if ($code) {
			...
			if (!mysqli_query($link, "
				UPDATE creditos SET code_ps = '$code' WHERE referencia = '{$_GET['r']}' ")) echo "erro db...";
