...
// Objetivo
// Pegar codigo do status (ver questao de 5 vezes sistema fora do ar)
// se 3 (PAID) - aprovar credito, enviar email cliente, vendedor (se pagseg avisar, desnecessario enviar email)
// se 4 (AVAILABLE) - enviar email vendedor (se pagseg avisar, desnecessario)
// se 7 (CANCELLED) - enviar email cliente
...
require_once "../PagSeguroLibrary/PagSeguroLibrary.php";
	...
	//$status = $transaction->getStatus();  
				...
				$subject = "123 test status, seu Crédito WEBECARD.net foi Aprovado.";
					...
					<html>
					  <body bgcolor='lightyellow'>
						...
						<br>
							...
							<br>
							<p>Parabéns, seu crédito de R$" . $status->getValue() . " reais foi aprovado.</p> 
							<br>
